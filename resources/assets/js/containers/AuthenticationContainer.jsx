	...
	renderIsAuthenticated() {
		return (
			<div>
				...
				<p><strong>Note:</strong> This will disable all EV Control functionality</p>
			</div>
		);
	}
		...
		return (
			<div>
				...
				<Panel header="What happens after I connect?">
					Shortly after connecting your Tesla account to EV Control we will start retrieving and visualize your driving, charging and climate data. We will <strong>only</strong> perform API calls that reads data, unless you explicitly configure EV Control to do otherwise.
				</Panel>
			</div>
		);
	}
